...
* ~~PDF extraction requires pdftotext be installed, [link](http://www.foolabs.com/xpdf/download.html)~~ Used pdf-parse npm module for parsing pdf files.
* ~~DOC extraction requires antiword be installed, [link](http://www.winfield.demon.nl/)~~ Used word-extractor npm module for parsing word files.
